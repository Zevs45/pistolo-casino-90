...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-88eb142f');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-88eb142f');}
...
function clearFlash(){dieView.classList.remove('rl-win-88eb142f');dieView.classList.remove('rl-lose-88eb142f');if(frameEl){frameEl.classList.remove('rl-win-88eb142f');frameEl.classList.remove('rl-lose-88eb142f');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-88eb142f');if(frameEl){frameEl.classList.add('rl-win-88eb142f');}}else{dieView.classList.add('rl-lose-88eb142f');if(frameEl){frameEl.classList.add('rl-lose-88eb142f');}}
...
var brandEl=document.querySelector('.rl-brand-88eb142f');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
